...
var uikit = {
	...
	sliders: function () {
		...
		$(".js-comments-slider-2").slick({
			...
			nextArrow: '<button type="button" class="partners-section__arrow-next slick-next slick-arrow"><svg class="icon"><path d="M0 25L12.5 25L25 12.5L12.5 0L0 0L12.5 12.5L0 25Z" /></svg></button>',

			prevArrow: '<button type="button" class="partners-section__arrow-prev slick-prev slick-arrow"><svg class="icon"><path d="M0 25L12.5 25L25 12.5L12.5 0L0 0L12.5 12.5L0 25Z" /></svg></button>',
